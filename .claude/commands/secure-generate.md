...
Every piece of generated code is held to the ten SSEM attributes (FIASSE v1.1):
...
- **Integrity** (S3.2.3.2) — Input validation at trust boundaries (canonicalize → sanitize → validate, S4.4.1), parameterized queries, Isolated Integrity Principle (S4.4.1.2), Canonical Parsing (S4.4.1.1)
...
Cross-cutting principles: **Transparency** (S2.6), **Least Astonishment** (S2.7), and **Boundary Control** (S4.3).
