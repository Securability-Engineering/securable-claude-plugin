...
These files are derived from the [Xcaciv/securable_software_engineering](https://github.com/Xcaciv/securable_software_engineering) repository. Licensed under [CC BY SA 4.0](https://creativecommons.org/licenses/by/4.0/).
